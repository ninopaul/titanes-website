  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-end gap-3">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_4px_30px_rgba(37,211,102,0.6)] transition-shadow duration-300"
        aria-label="WhatsApp"
      >
        {/* Ping animation */}
